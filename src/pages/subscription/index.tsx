    ...
    <div className="bg-[#161616] text-white min-h-screen flex flex-col items-center py-6">
      <div className="w-full max-w-4xl p-6">
        ...
        <div className="mb-6 flex justify-center space-x-6">
          ...
          <Button size="sm" className={`bg-[black] text-thite border-2 border-white ${selectedPeriod === '6 months' ? 'bg-[#161616] text-white' : 'bg-[#161616] text-gray-400'}`}
            onClick={() => handleTabChange('6 months')}
          >6 Months</Button>
        
        <Button size="sm" className={`bg-[black] text-thite border-2 border-white ${selectedPeriod === 'yearly' ? 'bg-[#161616] text-white' : 'bg-[#161616] text-gray-400'}`}
            onClick={() => handleTabChange('6 months')}
          >Yearly</Button>
        </div>
